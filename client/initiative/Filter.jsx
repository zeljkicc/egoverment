  	...
  	<ReactCSSTransitionGroup
	  	...
	  	<div className="row">
		  	<div className="col-md-4 col-xs-12">
		  		<h3>NAZIV</h3>
		  		<Divider />
		  		<FlatButton label="A do Z" name="AdoZ"  fullWidth={true} onTouchTap={this.handleTouchTap.bind(this, "atoz")} 
		  		  labelStyle={(this.state.sort === "atoz") ? {fontWeight:"bold"} : ""}/>
		  		<FlatButton label="Z do A" fullWidth={true} onTouchTap={this.handleTouchTap.bind(this, "ztoa")}
			...
			<div className="col-md-4 col-xs-12">
				<h3>REJTING</h3>
				<Divider />
				<FlatButton label="Prvo najvisi" fullWidth={true} onTouchTap={this.handleTouchTap.bind(this, "highest")}
				labelStyle={(this.state.sort === "highest") ? {fontWeight:"bold"} : ""}/>
		  		<FlatButton label="Prvo najnizi" fullWidth={true} onTouchTap={this.handleTouchTap.bind(this, "lowest")}
